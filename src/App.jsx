...
export default function TrollslandeApp() {
  ...
  const styles = {
    ...
    primaryButton: { width: "100%", padding: "6px 12px", borderRadius: 12, border: "1px solid #0f172a", background: "#0f172a", color: "white", fontSize: 14, fontWeight: 700, cursor: "pointer" },
    secondaryButton: { width: "100%", padding: "6px 12px", borderRadius: 12, border: "1px solid #0f172a", background: "#0f172a", color: "white", fontSize: 14, fontWeight: 700, cursor: "pointer" },
